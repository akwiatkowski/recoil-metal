...
| **The blueprint schema's own docs** (`C-165`) | **1,311 keys with the engine's one-line description of each**, in offset order | Found late; names any blueprint offset by position |
