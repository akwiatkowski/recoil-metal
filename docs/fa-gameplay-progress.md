...
| [`FA-INTEL`](#fa-intel---vision-radar-sonar-and-counter-intel) | Vision, radar, sonar, counter-intel | `WP-33` | 80% | 50% | 90% | Radar blip error now scores automatic acquisition (identity and row-then-distance ordering kept); next is time-based contact expiry. |
