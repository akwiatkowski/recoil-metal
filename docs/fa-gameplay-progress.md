...
Retail-analyzed   [#################---] about 82%
```

The row estimates average 63.63%, 39.74% and 82.50%, respectively. The 2026-09-18
...
and the 82% equal-subsystem estimate answer different questions and are shown together to keep the
headline honest.
